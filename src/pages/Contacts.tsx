				...
				<div className='contact-information__grid'>
					<div className='contact-information__item'>
						...
						<div className='contact-information__item__text'>
							...
							<p>
								10 Rue des Musiciens, 75001 Paris Адрес для почты: 123456, ville de Musique, 10 Rue
								des Musiciens, 75001 Paris.
							</p>
							<span>Обратите внимание</span>
							<p>
								Французский офис открыт только для сотрудников и официальных партнеров компании. Мы
								не принимаем посетителей и не проводим экскурсий. Присутствие посторонних на
