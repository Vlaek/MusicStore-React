		...
		<div className='container'>
			...
			<div className='description'>
				<p className='description__text'>
					Добро пожаловать в наш интернет-магазин музыки! Мы - команда энтузиастов, которые любят и
					ценят качественную музыку. Наша история началась много лет назад, когда мы решили создать
					место, где любители музыки могут находить и покупать самые разные жанры и исполнителей.
				</p>
				...
				<p className='description__text'>
					...
					интернет-магазинов музыки. Наша коллекция включает в себя тысячи альбомов, сотни жанров и
					исполнителей со всего мира. Мы предлагаем только качественную музыку, которую мы сами
					слушаем и любим.
				</p>
				<p className='description__text'>
					Мы гордимся тем, что можем предложить нашим клиентам не только широкий выбор музыки, но и
					отличный сервис. Мы всегда готовы помочь нашим клиентам с выбором альбома, ответить на
				...
				<p className='description__text'>
					...
					это место, где каждый найдет что-то для себя. Мы ценим каждого нашего клиента и стремимся
					предоставить только лучший сервис и продукт.
				</p>
				<p className='description__text'>
